...
۱. **قالب رو با دستور زیر دانلود کنید**
   ```sh
   sudo wget -N -P /var/lib/marzban/templates/subscription/ https://github.com/HellthonAriya/MarzViteTemplate/releases/download/v.1.1/index.html
   ```
...
۱. **قالب رو با دستور زیر دانلود کنید**
   ```sh
   sudo wget -N -P /var/lib/marzneshin/templates/subscription/ https://github.com/HellthonAriya/MarzViteTemplate/releases/download/v.1.1/index.html
   ```
...
- **اپلیکیشن ها**: [public-assets Apps JSON](https://github.com/HellthonAriya/public-assets/blob/main/json/apps.json)
- **لیست پشتیبانی**: [public-assets Socials JSON](https://github.com/HellthonAriya/public-assets/blob/main/json/social.json)
...
- **Apps List**: [public-assets Apps JSON](https://github.com/HellthonAriya/public-assets/blob/main/json/apps.json)
...
- **Support List**: [public-assets Socials JSON](https://github.com/HellthonAriya/public-assets/blob/main/json/social.json)
